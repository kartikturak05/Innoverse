...
const Services = () => {
    return (
        <div className=" min-h-screen flex flex-col items-center cursor-grab" style={{
            ...
            {/* Services Container */}
            <div className="flex justify-center w-full max-w-6xl max-h-screen mt-12 gap-0 bg-white p-7 rounded-[80px] sm:flex-wrap md:flex-nowrap cursor-grab">
                {/* First Service */}
                <div className="relative w-full md:w-1/3 bg-white rounded-3xl p-6 flex flex-col items-center cursor-grab">
                ...
                {/* Second Service */}
                <div className="relative w-full md:w-1/3 bg-white rounded-lg p-6 flex flex-col items-center cursor-grab">
                ...
                {/* Third Service */}
                <div className="w-full md:w-1/3 bg-white rounded-lg p-6 flex flex-col items-center cursor-grab">
